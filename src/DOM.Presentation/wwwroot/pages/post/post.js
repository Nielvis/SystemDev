...
function Register() {
    ...
    html += Form();
    html += "<hr>";
    html += "<a id='btnRegister'>Crie o seu Post</a>";
...
function Get() {
    ...
    html += "<a data-bs-toggle=\"modal\" data-bs-target=\"#modal\" onclick='Register()'>Crie o seu Post</a>";
    html += "<hr />";
    ...
    if (result.length > 0) {
        $.each(result, function (index, json) {
            ...
            html += "<td><a  data-bs-toggle=\"modal\" data-bs-target=\"#modal\" onclick='Edit(\"" + json.uid + "\")'><i class=\"fa-solid fa-pen-to-square\"></i></a></td>"; //<a onclick='Delete(\"" + json.name + "\",\"" + json.uid + "\")'><i class=\"fa-solid fa-trash\"></i></a>
            html += "</tr>";
        });
    } else {
        html += "<tr>";
