...
function Register() {
    ...
    $("#btnRegister").click(function () {
        ...
        JAjaxSync("POST", "/v1/api/text", JSON.stringify(Obj), null, null, null);
...
function Edit(uid) {
    ...
    let result = JAjaxReturnLineSync("GET", "/v1/api/text/" + uid, null, null, null, null);
    ...
    $("#btnEdit").click(function () {
        ...
        JAjaxSync("PUT", "/v1/api/text/" + $("#uid").val(), JSON.stringify(Obj), null, null, null);
        iziToast.success({
            title: 'OK',
...
function Get() {
    ...
    let result = JAjaxReturnLineSync("GET", "/v1/api/text", null, null, null, null);
    ...
    iziToast.show({
        ...
        buttons: [
            ['Ok', function (instance, toast) {
                JAjaxSync("DELETE", "/v1/api/text/" + uid, null, null, null, null);
                iziToast.success({
                    title: 'OK',
